  ...
  return (
    ...
    <Modal show={show} onHide={handleClose}>
      ...
      <div className='todo-filters-container'>
        <div className='form-check form-switch d-flex align-items-center' style={{ marginLeft: '0.5rem', marginRight: '0.5rem'}}>
          <input 
            ...
            ref={onlyWaitingRef}
          />
          <label className='form-check-label d-flex align-items-center' htmlFor='flexSwitchCheckChecked' style={{ marginLeft: '0.5rem', marginRight: '0.5rem'  }}>
            Show only&nbsp;
